            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-policy" style="text-align: justify;">
                        ...
                        <p>
                            Chúng tôi thu thập, lưu trữ và xử lý thông tin của bạn cho quá trình mua hàng và cho những thông báo sau này, và để cung cấp dịch vụ. Chúng tôi không giới hạn thông tin cá nhân: danh hiệu, tên, giới tính, ngày sinh, email, địa chỉ, địa chỉ giao hàng, số điện thoại, chi tiết thanh toán.
                        ...
                        <p>Chi tiết đơn đặt hàng của bạn được chúng tôi lưu giữ nhưng vì lí do bảo mật nên chúng tôi không công khai trực tiếp được. Tuy nhiên, quý khách có thể tiếp cận thông tin bằng cách đăng nhập tài khoản trên web. Tại đây quý khách có thể xem lich sử mua hàng, thông tin chi tiết các đơn hàng, kể cả đơn hàng đã huỷ,... </p>
                        <strong>Điều lệ khác về thông tin cá nhân</strong>
                        <p class="pt-20">Chúng tôi cam kết không buôn bán, trao đổi thông tin bảo mật của khách hàng cho bất kỳ bên thứ ba nào. Tuy nhiên, trong một số trường hợp đặc biệt sau đây, chúng tôi có thể chia sẻ thông tin cách hàng: 
                        <br>1/ Được sợ đồng ý của khách hàng.
                        <br>2/ Theo yêu cầu của những cơ quan chính phủ khi chúng tôi thấy phù hợp với pháp luật Việt Nam.
                        </p>
                        ...
                        <p class="pt-20 mb-50">Quý khách có quyền yêu cầu truy cập vào dữ liệu cá nhân của mình, bất cứ lúc nào bạn cũng có quyền yêu cầu chúng tôi ngưng sử dụng dữ liệu cá nhân của bạn cho mục đích tiếp thị.</p>
                    </div>
                </div>
            </div>
        </main>
