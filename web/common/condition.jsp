        ...
        <section class="breadcrum">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb container">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Điều khoản dịch vụ</li>
                </ol>
            </nav>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-policy" style="text-align: justify;">
                        ...
                        <h5>Chào mừng bạn đến với VnProX!</h5>
                        <p>Chào mừng quý khách hàng đến với website chúng tôi.<br><br>
                            Khi quý khách hàng truy cập vào trang website của chúng tôi có nghĩa là quý khách đồng ý với các điều khoản này. Trang web có quyền thay đổi, chỉnh sửa, thêm hoặc lược bỏ bất kỳ phần nào trong Điều khoản mua bán hàng hóa này, vào bất cứ lúc nào. Các thay đổi có hiệu lực ngay khi được đăng trên trang web mà không cần thông báo trước. Và khi quý khách tiếp tục sử dụng trang web, sau khi các thay đổi về Điều khoản này được đăng tải, có nghĩa là quý khách chấp nhận với những thay đổi đó.
                            <br><br>Quý khách hàng vui lòng kiểm tra thường xuyên để cập nhật những thay đổi của chúng tôi.
                        </p>
                        ...
                        <p>Việc bạn sử dụng Dịch vụ của chúng tôi không có nghĩa là bạn được sở hữu bất cứ các quyền sở hữu
                            ...
                            hoặc logo nào được sử dụng trong Dịch vụ của chúng tôi. Không được xóa, che khuất hoặc thay đổi
                            bất kỳ thông báo pháp lý nào được hiển thị trong hoặc kèm theo Dịch vụ của chúng tôi.</p>
                        
                        
                        <strong>Hình thức thanh toán và giao hàng</strong>
                        <p class="pt-20 ">1/ Phương thức giao hàng hỗ trợ thời điểm hiện tại là nhà cung cấp giao. Phí giao hàng sẽ được nhà cung cấp liên hệ với người nhận hàng qua số điện thoại.</p>
                        <p>2/ Phương thức thanh toán hỗ trợ thời gian thời điểm hiện tại là thanh toán khi nhận hàng(Tiền mặt hoặc chuyển khoản).</p>
