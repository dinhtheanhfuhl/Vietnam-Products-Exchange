                    ...
                    <div class=" personal-infor ">
                        <div class="col-md-8 col-sm-6 pt-3">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td> <button type="submit" id="btn-edit" for="formGroupExampleInput"
                                                     class="btn btn-warning ml-10"></button></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="hidden-edit pt-3">
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control appear-input mb-3 " id="inputName" placeholder="FirstName"
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control appear-input mb-3 " id="inputName" placeholder="LastName"
                                               aria-label="First name">
                        ...
                        <div class="col-md-8 col-sm-6 pt-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td id="display-userName-2"><label for="inputpass" class="form-label">Ngày sinh</label>
                                        </td>
                                        <td>
                        ...
                        <div class="col-md-8 col-sm-6 pt-4 pb-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label for="inputpass" class="form-label pass-infor">Giới tính</label></td>
                                        ...
                                        <td> <button type="submit" id="btn-edit-2" class="btn btn-warning ml-10"></button></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class=" hidden-pass pt-3">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="password" required class="form-control appear-input mb-3 " id="password"
                                               placeholder="New Password" aria-label="First name">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="password" class="form-control appear-input mb-3 " id="password_confirm"
                                           oninput="check(this)" placeholder="Confirm Password" aria-label="First name">
                                </div>
                                <button type="submit" class="btn btn-secondary updated-infor ml-10 mt-25">Cập nhật</button>
                        ...
                        <div class="col-md-8 col-sm-6 pt-4 pb-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label for="inputpass" class="form-label pass-infor">Email</label></td>
                                        <td class="display-userName-3">
                                            <input type="email" required class="form-control" id="inputpass" placeholder="email">
                                        </td>
                                        <td> <button type="submit" id="btn-edit-2" class="btn btn-warning ml-10"></button></td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="col-md-8 col-sm-6 pt-4 pb-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label for="inputpass" class="form-label pass-infor">Số điện thoại</label></td>
                                        <td class="display-userName-3">
                                            <input type="password" required class="form-control" id="inputpass" placeholder="số điện thoại">
                                        </td>
                            ...
                            <div class=" hidden-pass pt-3">
                                ...
                                <div class="form-group ">
                                    <label for="inputName" class="col-sm-6 col-form-label">Nhập số điện thoại mới</label>
                                    <div class="col-sm-10">
                                        <input type="password" required class="form-control appear-input mb-3 " id="password"
                                               placeholder="New Password" aria-label="First name">
                                    </div>
                        ...
                        <div class="col-md-8 col-sm-6 pt-4 pb-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label for="inputpass" class="form-label pass-infor">Nhà cung cấp</label></td>
                                        <td class="display-userName-3">
                                            <input type="password" required class="form-control" id="inputpass" placeholder="nhà cung cấp">
                                        </td>
                                        <td> <button type="submit" id="btn-edit-2" class="btn btn-warning ml-10">Chỉnh
                                                sửa</button></td>
                                    </tr>
                        ...
                        <div class="col-md-8 col-sm-6 pt-4 pb-4">
                            <table>
                                <tbody>
                                    <tr>
                                        <td><label for="inputpass" class="form-label pass-infor">Cơ sở chính</label></td>
                                        <td class="display-userName-3">
                                            <input type="password" required class="form-control" id="inputpass" placeholder="cơ sở chính">
                                        </td>
                                        <td> <button type="submit" id="btn-edit-2" class="btn btn-warning ml-10">Chỉnh
                                                sửa</button></td>
                                    </tr>
