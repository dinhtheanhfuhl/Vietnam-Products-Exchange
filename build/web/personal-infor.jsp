      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link waves-effect text-header dropdown-toggle" href="" target="_blank">Giới thiệu
            ...
            <li class="nav-item">
              <div class="dropdown">
                <a class="nav-link waves-effect text-header dropdown-toggle" href="./shop.html" target="_blank">Cửa hàng
          ...
          <ul class="navbar-nav nav-flex-icons">
            <li class="nav-item ">
              <a href="#" class="nav-link cart-btn amm-shopping-cart-open pr-3"><i onclick="shoppingCarts()"
      ...
      <div class="col-md-3 mt-50 mb-50">
        <div class="profile-sidebar">
          ...
          <div class="profile-usertitle">
            ...
            <div class="profile-usertitle-job"> abc@gmail.com </div>
          </div>
            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                    <input type="email" required class="form-control" id="inputpass" placeholder="Mật khẩu">
                  </td>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="display-userName-3">
                    <input type="password" required class="form-control" id="inputpass" placeholder="Mật khẩu">
                  </td>
